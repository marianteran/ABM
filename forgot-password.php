...
<head>
    ...
    <title>ABM Clientes- Olvidaste la Clave</title>
                            ...
                            <div class="col-lg-6">
                                <div class="p-5">
                                    <div class="text-center">
                                        ...
                                        <p class="mb-4">Solo tienes que introducir tu dirección de correo electrónico a continuación
                                    ...
                                    <form class="user" method="post" action="forgot-password.php">
                                        <div class="form-group">
                                            <input type="email" class="form-control form-control-user"
                                                id="txtCorreo" name="txtCorreo" aria-describedby="emailHelp"
