                        ...
                        <div class="p-5">
                            ...
                            <form class="user" method="post" action="register.php">
                                ...
                                <div class="form-group">
                                    <input type="email" class="form-control form-control-user" id="txtCorreo" name="txtCorreo" placeholder="Correo">
                                </div>
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-6">
                                        <input type="password" class="form-control form-control-user" id="txtClave" name="txtClave" placeholder="Repetir clave">
                                    </div>
                                </div>
                                <a href="login.php" class="btn btn-primary btn-user btn-block">
                                    <button type="submit" class="btn btn-primary btn-user" id="btnGuardar" name="btnGuardar">Registrar Cuenta
                                    </button>
                                </a>
